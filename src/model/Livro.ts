...
export class Livro {
    ...
    private statusLivro: boolean = true; // status de registro do livro
    ...
    */
    ...
    /**
     * Retorna o status de registro do livro
     * @returns status de registro do livro : statusLivroRegistro
     */
    ...
    */
    static async removerLivro(id_livro: number): Promise<Boolean> {
        ...
        try {
            ...
            const queryDeleteEmprestimoLivro = `  UPDATE Livro 
